function [p2lvlSimpd, p2lvlTheo, L] = double_diffr_for_cmp_lerch(spos, rpos, N1p, N2p, fr, betas, betar)
% calculate the attenuation of 2.5D thick barrier. Comment the theoretical
% calculation out.

function [levelMinusFFatL, distanceL, vIdx] = multi_diffr2_engr(spos, rpos, vertex, beta, properClaim, fr, M, PLOT, varargin)
...
if nargin==9
    N2xsq = varargin{1};
    [levelMinusFFatL, distanceL] = multi_diffr(propaPath, nupi, thetasn, thetan, fr, M, N2xsq);
else
    [levelMinusFFatL, distanceL] = multi_diffr(propaPath, nupi, thetasn, thetan, fr, M);
end
